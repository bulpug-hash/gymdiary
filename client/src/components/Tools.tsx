...
function ExportData({ workoutData }: { workoutData: WorkoutDataHook }) {
  ...
  const exportXLSX = () => {
    ...
    const metadata: (string | null)[][] = [
      ...
      ['Konec plánu', '16. 11. 2026'],
      ['Počet týdnů', '13'],
      ['Fáze 1', 'Akumulace W1–4 (18.8.–14.9.2026)'],
      ['Fáze 2', 'Síla W5–8 (15.9.–12.10.2026)'],
      ['Fáze 3', 'Intenzifikace W9–11 (13.10.–2.11.2026)'],
      ['Fáze 4', 'Taper+Test W12–13 (3.–16.11.2026)'],
