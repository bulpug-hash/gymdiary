...
export const WEEK_GUIDE: WeekGuide[] = [
  {
    ...
    main: [{ lift: 'Dřep (Po)', text: '145×8 (Objemová) → 162.5×3 (OVERLOAD) → 152.5×6 (Back-off) → 152.5×6 (Back-off)' }, { lift: 'Bench (Ne)', text: '100×8 (Objemová) → 112.5×3 (OVERLOAD) → 105×6 (Back-off) → 105×6 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '180×8 (Objemová) → 202.5×3 (OVERLOAD) → 190×6 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Pracovní série RPE 7–8 (2–3 opakování v zásobě). Overload RPE 8.',
  },
  {
    ...
    points: ['Doplňky jedou na vyšší opakování (8–12) – víc objemu, nižší váhy.', 'Face pull navíc na zdraví ramen.', 'Nohy drž silově, nepřidávej vysokoopakovkové drtičky.'],
    rotation: [{ slot: 'Nohy – doplněk', value: 'Bulharský dřep' }, { slot: 'Dřep – variace', value: 'Pauzový dřep (2 s)' }, { slot: 'Bench – variace', value: 'Pauzový / Spoto press' }, { slot: 'Triceps (místo dipů)', value: 'Triceps pushdown' }, { slot: 'Veslování', value: 'Barbell row' }, { slot: 'Pull-up úchop', value: 'úzko/podhmat · široko' }, { slot: 'Biceps', value: 'jednoručky · kladívkový' }, { slot: 'Hamstringy', value: 'Nordic curl' }],
    main: [{ lift: 'Dřep (Po)', text: '147.5×8 (Objemová) → 167.5×2 (OVERLOAD) → 152.5×6 (Back-off) → 152.5×5 (Back-off)' }, { lift: 'Bench (Ne)', text: '102.5×8 (Objemová) → 115×2 (OVERLOAD) → 107.5×6 (Back-off) → 107.5×5 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '185×8 (Objemová) → 207.5×2 (OVERLOAD) → 195×6 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Pracovní série RPE 7–8 (2–3 opakování v zásobě). Overload RPE 8.',
  },
  {
    ...
    rotation: [{ slot: 'Nohy – doplněk', value: 'Bulharský dřep' }, { slot: 'Dřep – variace', value: 'Pauzový dřep (2 s)' }, { slot: 'Bench – variace', value: 'Pauzový / Spoto press' }, { slot: 'Triceps (místo dipů)', value: 'Triceps pushdown' }, { slot: 'Veslování', value: 'Barbell row' }, { slot: 'Pull-up úchop', value: 'úzko/podhmat · široko' }, { slot: 'Biceps', value: 'jednoručky · kladívkový' }, { slot: 'Hamstringy', value: 'Nordic curl' }],
    main: [{ lift: 'Dřep (Po)', text: '152.5×6 (Objemová) → 170×2 (OVERLOAD) → 155×6 (Back-off) → 155×5 (Back-off)' }, { lift: 'Bench (Ne)', text: '105×6 (Objemová) → 117.5×2 (OVERLOAD) → 110×6 (Back-off) → 110×5 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '187.5×6 (Objemová) → 212.5×2 (OVERLOAD) → 197.5×6 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Top set RPE 8–9 (1–2 v zásobě). Back-offy RPE 8.',
  },
  {
    ...
    rotation: [{ slot: 'Nohy – doplněk', value: 'Bulharský dřep' }, { slot: 'Dřep – variace', value: 'Pauzový dřep (2 s)' }, { slot: 'Bench – variace', value: 'Pauzový / Spoto press' }, { slot: 'Triceps (místo dipů)', value: 'Triceps pushdown' }, { slot: 'Veslování', value: 'Barbell row' }, { slot: 'Pull-up úchop', value: 'úzko/podhmat · široko' }, { slot: 'Biceps', value: 'jednoručky · kladívkový' }, { slot: 'Hamstringy', value: 'Nordic curl' }],
    main: [{ lift: 'Dřep (Po)', text: '130×5 (Deload) → 130×5 (Deload) → 132.5×5 (Deload)' }, { lift: 'Bench (Ne)', text: '90×5 (Deload) → 90×5 (Deload) → 92.5×5 (Deload)' }, { lift: 'Mrtvý tah (Čt)', text: '160×5 (Deload) → 160×5 (Deload) → 165×5 (Deload)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Vše RPE 6–7. Má to být lehké.',
  },
  {
    ...
    main: [{ lift: 'Dřep (Po)', text: '157.5×5 (TOP) → 165×3 (OVERLOAD) → 152.5×5 (Back-off) → 152.5×5 (Back-off)' }, { lift: 'Bench (Ne)', text: '107.5×5 (TOP) → 112.5×3 (OVERLOAD) → 105×5 (Back-off) → 105×5 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '195×5 (TOP) → 205×3 (OVERLOAD) → 187.5×5 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Top set RPE 8–9 (1–2 v zásobě). Back-offy RPE 8.',
  },
  {
    ...
    points: ['Doplňky jedou na vyšší opakování (8–12) – víc objemu, nižší váhy.', 'Face pull navíc na zdraví ramen.', 'Nohy drž silově, nepřidávej vysokoopakovkové drtičky.'],
    rotation: [{ slot: 'Nohy – doplněk', value: 'Chodící výpady' }, { slot: 'Dřep – variace', value: 'Pin dřep (z kolíků)' }, { slot: 'Bench – variace', value: 'Dlouhý pauzový (3 s) / Spoto' }, { slot: 'Triceps (místo dipů)', value: 'Overhead extension' }, { slot: 'Veslování', value: 'Chest-supported row' }, { slot: 'Pull-up úchop', value: 'neutrál · střední' }, { slot: 'Biceps', value: 'šikmá lavice · jednoručky' }, { slot: 'Hamstringy', value: 'GHD raise' }],
    main: [{ lift: 'Dřep (Po)', text: '160×4 (TOP) → 167.5×2 (OVERLOAD) → 155×5 (Back-off) → 155×4 (Back-off)' }, { lift: 'Bench (Ne)', text: '110×4 (TOP) → 115×2 (OVERLOAD) → 107.5×5 (Back-off) → 107.5×4 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '200×4 (TOP) → 210×2 (OVERLOAD) → 192.5×5 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Pracovní série RPE 7–8 (2–3 opakování v zásobě). Overload RPE 8.',
  },
  {
    ...
    points: ['Doplňky silově (4–6 op.), přidej zátěž na pull-upy a dipy nahrazující triceps.', 'Nordic curl / GHD jen v tomhle typu týdne.', 'Veslování 4×5 místo 3×8–10.'],
    rotation: [{ slot: 'Nohy – doplněk', value: 'Chodící výpady' }, { slot: 'Dřep – variace', value: 'Pin dřep (z kolíků)' }, { slot: 'Bench – variace', value: 'Dlouhý pauzový (3 s) / Spoto' }, { slot: 'Triceps (místo dipů)', value: 'Overhead extension' }, { slot: 'Veslování', value: 'Chest-supported row' }, { slot: 'Pull-up úchop', value: 'neutrál · střední' }, { slot: 'Biceps', value: 'šikmá lavice · jednoručky' }, { slot: 'Hamstringy', value: 'GHD raise' }],
    main: [{ lift: 'Dřep (Po)', text: '167.5×3 (TOP) → 172.5×2 (OVERLOAD) → 157.5×4 (Back-off) → 157.5×4 (Back-off)' }, { lift: 'Bench (Ne)', text: '115×3 (TOP) → 117.5×2 (OVERLOAD) → 107.5×4 (Back-off) → 107.5×4 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '207.5×3 (TOP) → 215×2 (OVERLOAD) → 195×4 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Top set RPE 8–9 (1–2 v zásobě). Back-offy RPE 8.',
  },
  {
    ...
    points: ['Nejezdi do selhání, RPE max 6–7.', 'Doplňky zredukované na 2 série.', 'Spánek a jídlo priorita – deload je práce na regeneraci.'],
    rotation: [{ slot: 'Nohy – doplněk', value: 'Chodící výpady' }, { slot: 'Dřep – variace', value: 'Pin dřep (z kolíků)' }, { slot: 'Bench – variace', value: 'Dlouhý pauzový (3 s) / Spoto' }, { slot: 'Triceps (místo dipů)', value: 'Overhead extension' }, { slot: 'Veslování', value: 'Chest-supported row' }, { slot: 'Pull-up úchop', value: 'neutrál · střední' }, { slot: 'Biceps', value: 'šikmá lavice · jednoručky' }, { slot: 'Hamstringy', value: 'GHD raise' }],
    main: [{ lift: 'Dřep (Po)', text: '140×3 (Deload) → 140×3 (Deload) → 142.5×3 (Deload)' }, { lift: 'Bench (Ne)', text: '95×3 (Deload) → 95×3 (Deload) → 97.5×3 (Deload)' }, { lift: 'Mrtvý tah (Čt)', text: '172.5×3 (Deload) → 172.5×3 (Deload) → 177.5×3 (Deload)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Vše RPE 6–7. Má to být lehké.',
  },
  {
    ...
    main: [{ lift: 'Dřep (Po)', text: '162.5×3 (Nájezd) → 172.5×2 (TOP) → 157.5×5 (Back-off) → 157.5×5 (Back-off)' }, { lift: 'Bench (Ne)', text: '112.5×3 (Nájezd) → 117.5×2 (TOP) → 107.5×5 (Back-off) → 107.5×5 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '202.5×3 (Nájezd) → 215×2 (TOP) → 195×5 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Top set RPE 8–9 (1–2 v zásobě). Back-offy RPE 8.',
  },
  {
    ...
    points: ['Doplňky jedou na vyšší opakování (8–12) – víc objemu, nižší váhy.', 'Face pull navíc na zdraví ramen.', 'Nohy drž silově, nepřidávej vysokoopakovkové drtičky.'],
    rotation: [{ slot: 'Nohy – doplněk', value: 'Leg press' }, { slot: 'Dřep – variace', value: 'Pauzový dřep (2 s)' }, { slot: 'Bench – variace', value: 'Pin press / Spoto' }, { slot: 'Triceps (místo dipů)', value: 'Skull crusher / JM press' }, { slot: 'Veslování', value: 'Pendlay row' }, { slot: 'Pull-up úchop', value: 'úzko/podhmat · široko' }, { slot: 'Biceps', value: 'EZ osa · kladívkový' }, { slot: 'Hamstringy', value: 'Nordic curl' }],
    main: [{ lift: 'Dřep (Po)', text: '167.5×2 (Nájezd) → 175×1 (TOP single) → 160×4 (Back-off) → 160×3 (Back-off)' }, { lift: 'Bench (Ne)', text: '115×2 (Nájezd) → 120×1 (TOP single) → 110×4 (Back-off) → 110×3 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '207.5×2 (Nájezd) → 217.5×1 (TOP single) → 200×4 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Pracovní série RPE 7–8 (2–3 opakování v zásobě). Overload RPE 8.',
  },
  {
    ...
    points: ['Doplňky silově (4–6 op.), přidej zátěž na pull-upy a dipy nahrazující triceps.', 'Nordic curl / GHD jen v tomhle typu týdne.', 'Veslování 4×5 místo 3×8–10.'],
    rotation: [{ slot: 'Nohy – doplněk', value: 'Leg press' }, { slot: 'Dřep – variace', value: 'Pauzový dřep (2 s)' }, { slot: 'Bench – variace', value: 'Pin press / Spoto' }, { slot: 'Triceps (místo dipů)', value: 'Skull crusher / JM press' }, { slot: 'Veslování', value: 'Pendlay row' }, { slot: 'Pull-up úchop', value: 'úzko/podhmat · široko' }, { slot: 'Biceps', value: 'EZ osa · kladívkový' }, { slot: 'Hamstringy', value: 'Nordic curl' }],
    main: [{ lift: 'Dřep (Po)', text: '170×2 (Nájezd) → 180×1 (TOP single) → 162.5×3 (Back-off) → 162.5×3 (Back-off)' }, { lift: 'Bench (Ne)', text: '117.5×2 (Nájezd) → 122.5×1 (TOP single) → 112.5×3 (Back-off) → 112.5×3 (Back-off)' }, { lift: 'Mrtvý tah (Čt)', text: '212.5×2 (Nájezd) → 222.5×1 (TOP single) → 202.5×3 (Back-off)' }],
    cardio: 'St ráno běh podle běžeckého plánu, večer HIIT. So HIIT – když nevyjde, volný běh v Z2.', rpe: 'Top set RPE 8–9 (1–2 v zásobě). Back-offy RPE 8.',
  },
  {
    ...
    rotation: [{ slot: 'Nohy – doplněk', value: 'Leg press' }, { slot: 'Dřep – variace', value: 'Pauzový dřep (2 s)' }, { slot: 'Bench – variace', value: 'Pin press / Spoto' }, { slot: 'Triceps (místo dipů)', value: 'Skull crusher / JM press' }, { slot: 'Veslování', value: 'Pendlay row' }, { slot: 'Pull-up úchop', value: 'úzko/podhmat · široko' }, { slot: 'Biceps', value: 'EZ osa · kladívkový' }, { slot: 'Hamstringy', value: 'Nordic curl' }],
    main: [{ lift: 'Dřep (Po)', text: '167.5×1 (Opener) → 157.5×2 (Druhá) → 147.5×3 (Objem)' }, { lift: 'Bench (Ne)', text: '115×1 (Opener) → 107.5×2 (Druhá) → 102.5×3 (Objem)' }, { lift: 'Mrtvý tah (Čt)', text: '207.5×1 (Opener) → 195×2 (Druhá) → 185×3 (Objem)' }],
  ...
  },
  {
    ...
    rotation: [{ slot: 'Nohy – doplněk', value: 'Leg press' }, { slot: 'Dřep – variace', value: 'Pauzový dřep (2 s)' }, { slot: 'Bench – variace', value: 'Pin press / Spoto' }, { slot: 'Triceps (místo dipů)', value: 'Skull crusher / JM press' }, { slot: 'Veslování', value: 'Pendlay row' }, { slot: 'Pull-up úchop', value: 'úzko/podhmat · široko' }, { slot: 'Biceps', value: 'EZ osa · kladívkový' }, { slot: 'Hamstringy', value: 'Nordic curl' }],
    main: [{ lift: 'Dřep (Po)', text: '150×1 (Rozjezd) → 170×1 (Rozjezd) → 190×1 (CÍL) → 195×1 (PR (volitelně))' }, { lift: 'Bench (Ne)', text: '100×1 (Rozjezd) → 115×1 (Rozjezd) → 125×1 (Rozjezd) → 130×1 (CÍL) → 132.5×1 (PR (volitelně))' }, { lift: 'Mrtvý tah (Čt)', text: '180×1 (Rozjezd) → 207.5×1 (Rozjezd) → 230×1 (CÍL) → 235×1 (PR pokus)' }],
