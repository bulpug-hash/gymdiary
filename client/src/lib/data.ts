...
export const PLAN_START_DATE = '2026-08-31'; // W1 starts Monday 31 Aug 2026 (Podzim 2026 plán v5.2)
...
// NOVÝ PLÁN – PODZIM 2026 (v5.3) | 13 týdnů | Po bench · Čt mrtvý tah · Ne dřep

// Split: Po Upper(bench) · Út volno · St běh + HIIT · Čt Full(mrtvý tah) · Pá volno · So HIIT · Ne Lower(dřep)
...
const NP_DREP: [string,string,string,'lower'|'upper'|'fullbody',string] = ['sunday','Neděle','Ne','lower','DŘEP – nohy, silový důraz. Dřep vlnou + sekundární dřep + rotující leg cvik + core. Den po sobotní HIIT lekci: první série ber jako rozcvičku a při nízkém readiness uber z doplňků.'];
const NP_BENCH: [string,string,string,'lower'|'upper'|'fullbody',string] = ['monday','Pondělí','Po','upper','BENCH – tlak. Bench vlnou + variace na prsa + triceps (bez dipů) + pull-up (biceps) + biceps + core. Horní půlka, takže včerejší dřep nevadí.'];
const NP_TAH: [string,string,string,'lower'|'upper'|'fullbody',string] = ['thursday','Čtvrtek','Čt','fullbody','MRTVÝ TAH – tah/posterior. Tah vlnou + veslování + pull-up (záda) + biceps + hamstringy + core. 4 dny po nedělním dřepu.'];
...
const np2: Week = {
  number: 2, label: 'W2 – Akumulace', dateFrom: '2026-09-07', dateTo: '2026-09-13',
  phase: 'Blok A — Akumulace', phaseKey: 'phase1',
...
const np3: Week = {
  number: 3, label: 'W3 – Akumulace', dateFrom: '2026-09-14', dateTo: '2026-09-20',
  phase: 'Blok A — Akumulace', phaseKey: 'phase1',
...
const np4: Week = {
  number: 4, label: 'W4 – Deload', dateFrom: '2026-09-21', dateTo: '2026-09-27',
...
const np5: Week = {
  number: 5, label: 'W5 – Síla', dateFrom: '2026-09-28', dateTo: '2026-10-04',
...
const np6: Week = {
  number: 6, label: 'W6 – Síla', dateFrom: '2026-10-05', dateTo: '2026-10-11',
  phase: 'Blok B — Síla', phaseKey: 'phase2',
...
const np7: Week = {
  number: 7, label: 'W7 – Síla', dateFrom: '2026-10-12', dateTo: '2026-10-18',
  phase: 'Blok B — Síla', phaseKey: 'phase2',
...
const np8: Week = {
  number: 8, label: 'W8 – Deload', dateFrom: '2026-10-19', dateTo: '2026-10-25',
  phase: 'Deload', phaseKey: 'deload', isDeload: true,
...
const np9: Week = {
  number: 9, label: 'W9 – Intenzifikace', dateFrom: '2026-10-26', dateTo: '2026-11-01',
...
const np10: Week = {
  number: 10, label: 'W10 – Intenzifikace', dateFrom: '2026-11-02', dateTo: '2026-11-08',
  phase: 'Blok C — Intenzifikace', phaseKey: 'phase3',
...
const np11: Week = {
  number: 11, label: 'W11 – Intenzifikace', dateFrom: '2026-11-09', dateTo: '2026-11-15',
  phase: 'Blok C — Intenzifikace', phaseKey: 'phase3',
...
const np12: Week = {
  number: 12, label: 'W12 – Taper', dateFrom: '2026-11-16', dateTo: '2026-11-22',
...
const np13: Week = {
  number: 13, label: 'W13 – TEST MAXIM', dateFrom: '2026-11-23', dateTo: '2026-11-29',
...
export const NUTRITION = {
  ...
  /** Silový den (Po bench, Čt tah, Ne dřep) i den s během nebo HIIT. */
  trainingDay: {
    calories: 3500,
...
// kopce). Leží mezi čtvrtečním tahem a nedělním dřepem a lekci nahrazuje, nepřidává.
...
const volny = (duration: string, km: number, navic?: string, skupina?: string, description?: string): RunSession => ({
  ...
  description: description ?? 'Jen když nevyjde sobotní HIIT. Leží mezi čtvrtečním tahem a nedělním dřepem, proto vždycky Z2 — žádné tempo.',
  skupina,
});
...
export const PLANNED_RECORDS: RecordsMap = {
  'ab-wheel': [
    { id: 'plan-w1-ne-ab-wheel', date: '2026-09-06', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T1 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w1-po-ab-wheel', date: '2026-08-31', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T1 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w2-ne-ab-wheel', date: '2026-09-13', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T2 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w2-po-ab-wheel', date: '2026-09-07', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T2 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w3-ne-ab-wheel', date: '2026-09-20', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T3 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w3-po-ab-wheel', date: '2026-09-14', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T3 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w4-ne-ab-wheel', date: '2026-09-27', sets: '2', weight: '0', reps: '10', note: 'PLÁN · T4 · 2 × 10 · vlastní', planned: true },
    { id: 'plan-w4-po-ab-wheel', date: '2026-09-21', sets: '2', weight: '0', reps: '10', note: 'PLÁN · T4 · 2 × 10 · vlastní', planned: true },
    { id: 'plan-w5-ne-ab-wheel', date: '2026-10-04', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T5 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w5-po-ab-wheel', date: '2026-09-28', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T5 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w6-ne-ab-wheel', date: '2026-10-11', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T6 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w6-po-ab-wheel', date: '2026-10-05', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T6 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w7-ne-ab-wheel', date: '2026-10-18', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T7 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w7-po-ab-wheel', date: '2026-10-12', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T7 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w8-ne-ab-wheel', date: '2026-10-25', sets: '2', weight: '0', reps: '10', note: 'PLÁN · T8 · 2 × 10 · vlastní', planned: true },
    { id: 'plan-w8-po-ab-wheel', date: '2026-10-19', sets: '2', weight: '0', reps: '10', note: 'PLÁN · T8 · 2 × 10 · vlastní', planned: true },
    { id: 'plan-w9-ne-ab-wheel', date: '2026-11-01', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T9 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w9-po-ab-wheel', date: '2026-10-26', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T9 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w10-ne-ab-wheel', date: '2026-11-08', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T10 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w10-po-ab-wheel', date: '2026-11-02', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T10 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w11-ne-ab-wheel', date: '2026-11-15', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T11 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w11-po-ab-wheel', date: '2026-11-09', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T11 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w12-ne-ab-wheel', date: '2026-11-22', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T12 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w12-po-ab-wheel', date: '2026-11-16', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T12 · 3 × 10–12 · vlastní', planned: true },
  ],
  'ab-wheel-dl': [
    { id: 'plan-w1-ct-ab-wheel-dl', date: '2026-09-03', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T1 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w2-ct-ab-wheel-dl', date: '2026-09-10', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T2 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w3-ct-ab-wheel-dl', date: '2026-09-17', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T3 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w4-ct-ab-wheel-dl', date: '2026-09-24', sets: '2', weight: '0', reps: '10', note: 'PLÁN · T4 · 2 × 10 · vlastní', planned: true },
    { id: 'plan-w5-ct-ab-wheel-dl', date: '2026-10-01', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T5 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w6-ct-ab-wheel-dl', date: '2026-10-08', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T6 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w7-ct-ab-wheel-dl', date: '2026-10-15', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T7 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w8-ct-ab-wheel-dl', date: '2026-10-22', sets: '2', weight: '0', reps: '10', note: 'PLÁN · T8 · 2 × 10 · vlastní', planned: true },
    { id: 'plan-w9-ct-ab-wheel-dl', date: '2026-10-29', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T9 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w10-ct-ab-wheel-dl', date: '2026-11-05', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T10 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w11-ct-ab-wheel-dl', date: '2026-11-12', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T11 · 3 × 10–12 · vlastní', planned: true },
    { id: 'plan-w12-ct-ab-wheel-dl', date: '2026-11-19', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T12 · 3 × 10–12 · vlastní', planned: true },
  ],
  'db-row': [
    { id: 'plan-w1-ct-db-row', date: '2026-09-03', sets: '3', weight: '40', reps: '8–10', note: 'PLÁN · T1 · 3 × 8–10', planned: true },
    { id: 'plan-w2-ct-db-row', date: '2026-09-10', sets: '3', weight: '40', reps: '8–10', note: 'PLÁN · T2 · 3 × 8–10', planned: true },
    { id: 'plan-w3-ct-db-row', date: '2026-09-17', sets: '4', weight: '47.5', reps: '5', note: 'PLÁN · T3 · 4 × 5', planned: true },
    { id: 'plan-w4-ct-db-row', date: '2026-09-24', sets: '2', weight: '35', reps: '8', note: 'PLÁN · T4 · 2 × 8', planned: true },
  ],
  'bench': [
    { id: 'plan-w1-po-bench-0', date: '2026-08-31', sets: '1', weight: '100', reps: '8', note: 'PLÁN · T1 · Objemová · RPE 7-8', planned: true },
    { id: 'plan-w1-po-bench-1', date: '2026-08-31', sets: '1', weight: '112.5', reps: '3', note: 'PLÁN · T1 · OVERLOAD · RPE 8', planned: true },
    { id: 'plan-w1-po-bench-2', date: '2026-08-31', sets: '1', weight: '105', reps: '6', note: 'PLÁN · T1 · Back-off · RPE 7-8', planned: true },
    { id: 'plan-w1-po-bench-3', date: '2026-08-31', sets: '1', weight: '105', reps: '6', note: 'PLÁN · T1 · Back-off · RPE 7-8', planned: true },
    { id: 'plan-w2-po-bench-0', date: '2026-09-07', sets: '1', weight: '102.5', reps: '8', note: 'PLÁN · T2 · Objemová · RPE 8', planned: true },
    { id: 'plan-w2-po-bench-1', date: '2026-09-07', sets: '1', weight: '115', reps: '2', note: 'PLÁN · T2 · OVERLOAD · RPE 8', planned: true },
    { id: 'plan-w2-po-bench-2', date: '2026-09-07', sets: '1', weight: '107.5', reps: '6', note: 'PLÁN · T2 · Back-off · RPE 8', planned: true },
    { id: 'plan-w2-po-bench-3', date: '2026-09-07', sets: '1', weight: '107.5', reps: '5', note: 'PLÁN · T2 · Back-off · RPE 8', planned: true },
    { id: 'plan-w3-po-bench-0', date: '2026-09-14', sets: '1', weight: '105', reps: '6', note: 'PLÁN · T3 · Objemová · RPE 8', planned: true },
    { id: 'plan-w3-po-bench-1', date: '2026-09-14', sets: '1', weight: '117.5', reps: '2', note: 'PLÁN · T3 · OVERLOAD · RPE 8-9', planned: true },
    { id: 'plan-w3-po-bench-2', date: '2026-09-14', sets: '1', weight: '110', reps: '6', note: 'PLÁN · T3 · Back-off · RPE 8', planned: true },
    { id: 'plan-w3-po-bench-3', date: '2026-09-14', sets: '1', weight: '110', reps: '5', note: 'PLÁN · T3 · Back-off · RPE 8', planned: true },
    { id: 'plan-w4-po-bench-0', date: '2026-09-21', sets: '1', weight: '90', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6', planned: true },
    { id: 'plan-w4-po-bench-1', date: '2026-09-21', sets: '1', weight: '90', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6', planned: true },
    { id: 'plan-w4-po-bench-2', date: '2026-09-21', sets: '1', weight: '92.5', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w5-po-bench-0', date: '2026-09-28', sets: '1', weight: '107.5', reps: '5', note: 'PLÁN · T5 · TOP · RPE 8', planned: true },
    { id: 'plan-w5-po-bench-1', date: '2026-09-28', sets: '1', weight: '112.5', reps: '3', note: 'PLÁN · T5 · OVERLOAD · RPE 8-9', planned: true },
    { id: 'plan-w5-po-bench-2', date: '2026-09-28', sets: '1', weight: '105', reps: '5', note: 'PLÁN · T5 · Back-off · RPE 8', planned: true },
    { id: 'plan-w5-po-bench-3', date: '2026-09-28', sets: '1', weight: '105', reps: '5', note: 'PLÁN · T5 · Back-off · RPE 8', planned: true },
    { id: 'plan-w6-po-bench-0', date: '2026-10-05', sets: '1', weight: '110', reps: '4', note: 'PLÁN · T6 · TOP · RPE 8', planned: true },
    { id: 'plan-w6-po-bench-1', date: '2026-10-05', sets: '1', weight: '115', reps: '2', note: 'PLÁN · T6 · OVERLOAD · RPE 9', planned: true },
    { id: 'plan-w6-po-bench-2', date: '2026-10-05', sets: '1', weight: '107.5', reps: '5', note: 'PLÁN · T6 · Back-off · RPE 8', planned: true },
    { id: 'plan-w6-po-bench-3', date: '2026-10-05', sets: '1', weight: '107.5', reps: '4', note: 'PLÁN · T6 · Back-off · RPE 8', planned: true },
    { id: 'plan-w7-po-bench-0', date: '2026-10-12', sets: '1', weight: '115', reps: '3', note: 'PLÁN · T7 · TOP · RPE 8-9', planned: true },
    { id: 'plan-w7-po-bench-1', date: '2026-10-12', sets: '1', weight: '117.5', reps: '2', note: 'PLÁN · T7 · OVERLOAD · RPE 9', planned: true },
    { id: 'plan-w7-po-bench-2', date: '2026-10-12', sets: '1', weight: '107.5', reps: '4', note: 'PLÁN · T7 · Back-off · RPE 8', planned: true },
    { id: 'plan-w7-po-bench-3', date: '2026-10-12', sets: '1', weight: '107.5', reps: '4', note: 'PLÁN · T7 · Back-off · RPE 8', planned: true },
    { id: 'plan-w8-po-bench-0', date: '2026-10-19', sets: '1', weight: '95', reps: '3', note: 'PLÁN · T8 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w8-po-bench-1', date: '2026-10-19', sets: '1', weight: '95', reps: '3', note: 'PLÁN · T8 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w8-po-bench-2', date: '2026-10-19', sets: '1', weight: '97.5', reps: '3', note: 'PLÁN · T8 · Deload · RPE 7', planned: true },
    { id: 'plan-w9-po-bench-0', date: '2026-10-26', sets: '1', weight: '112.5', reps: '3', note: 'PLÁN · T9 · Nájezd · RPE 8', planned: true },
    { id: 'plan-w9-po-bench-1', date: '2026-10-26', sets: '1', weight: '117.5', reps: '2', note: 'PLÁN · T9 · TOP · RPE 9', planned: true },
    { id: 'plan-w9-po-bench-2', date: '2026-10-26', sets: '1', weight: '107.5', reps: '5', note: 'PLÁN · T9 · Back-off · RPE 8', planned: true },
    { id: 'plan-w9-po-bench-3', date: '2026-10-26', sets: '1', weight: '107.5', reps: '5', note: 'PLÁN · T9 · Back-off · RPE 8', planned: true },
    { id: 'plan-w10-po-bench-0', date: '2026-11-02', sets: '1', weight: '115', reps: '2', note: 'PLÁN · T10 · Nájezd · RPE 8', planned: true },
    { id: 'plan-w10-po-bench-1', date: '2026-11-02', sets: '1', weight: '120', reps: '1', note: 'PLÁN · T10 · TOP single · RPE 9', planned: true },
    { id: 'plan-w10-po-bench-2', date: '2026-11-02', sets: '1', weight: '110', reps: '4', note: 'PLÁN · T10 · Back-off · RPE 8', planned: true },
    { id: 'plan-w10-po-bench-3', date: '2026-11-02', sets: '1', weight: '110', reps: '3', note: 'PLÁN · T10 · Back-off · RPE 8', planned: true },
    { id: 'plan-w11-po-bench-0', date: '2026-11-09', sets: '1', weight: '117.5', reps: '2', note: 'PLÁN · T11 · Nájezd · RPE 8-9', planned: true },
    { id: 'plan-w11-po-bench-1', date: '2026-11-09', sets: '1', weight: '122.5', reps: '1', note: 'PLÁN · T11 · TOP single · RPE 9', planned: true },
    { id: 'plan-w11-po-bench-2', date: '2026-11-09', sets: '1', weight: '112.5', reps: '3', note: 'PLÁN · T11 · Back-off · RPE 8', planned: true },
    { id: 'plan-w11-po-bench-3', date: '2026-11-09', sets: '1', weight: '112.5', reps: '3', note: 'PLÁN · T11 · Back-off · RPE 8', planned: true },
    { id: 'plan-w12-po-bench-0', date: '2026-11-16', sets: '1', weight: '115', reps: '1', note: 'PLÁN · T12 · Opener · RPE 7', planned: true },
    { id: 'plan-w12-po-bench-1', date: '2026-11-16', sets: '1', weight: '107.5', reps: '2', note: 'PLÁN · T12 · Druhá · RPE 7', planned: true },
    { id: 'plan-w12-po-bench-2', date: '2026-11-16', sets: '1', weight: '102.5', reps: '3', note: 'PLÁN · T12 · Objem · RPE 7', planned: true },
    { id: 'plan-w13-po-bench-0', date: '2026-11-23', sets: '1', weight: '100', reps: '1', note: 'PLÁN · T13 · Rozjezd', planned: true },
    { id: 'plan-w13-po-bench-1', date: '2026-11-23', sets: '1', weight: '115', reps: '1', note: 'PLÁN · T13 · Rozjezd', planned: true },
    { id: 'plan-w13-po-bench-2', date: '2026-11-23', sets: '1', weight: '125', reps: '1', note: 'PLÁN · T13 · Rozjezd', planned: true },
    { id: 'plan-w13-po-bench-3', date: '2026-11-23', sets: '1', weight: '130', reps: '1', note: 'PLÁN · T13 · CÍL', planned: true },
    { id: 'plan-w13-po-bench-4', date: '2026-11-23', sets: '1', weight: '132.5', reps: '1', note: 'PLÁN · T13 · PR (volitelně)', planned: true },
  ],
  'bicep-curl': [
    { id: 'plan-w1-po-bicep-curl', date: '2026-08-31', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T1 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w2-po-bicep-curl', date: '2026-09-07', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T2 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w3-po-bicep-curl', date: '2026-09-14', sets: '3', weight: '0', reps: '6–8', note: 'PLÁN · T3 · 3 × 6–8 · střední', planned: true },
    { id: 'plan-w5-po-bicep-curl', date: '2026-09-28', sets: '3', weight: '0', reps: '6–8', note: 'PLÁN · T5 · 3 × 6–8 · střední', planned: true },
    { id: 'plan-w6-po-bicep-curl', date: '2026-10-05', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T6 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w7-po-bicep-curl', date: '2026-10-12', sets: '3', weight: '0', reps: '6–8', note: 'PLÁN · T7 · 3 × 6–8 · střední', planned: true },
    { id: 'plan-w9-po-bicep-curl', date: '2026-10-26', sets: '3', weight: '0', reps: '6–8', note: 'PLÁN · T9 · 3 × 6–8 · střední', planned: true },
    { id: 'plan-w10-po-bicep-curl', date: '2026-11-02', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T10 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w11-po-bicep-curl', date: '2026-11-09', sets: '3', weight: '0', reps: '6–8', note: 'PLÁN · T11 · 3 × 6–8 · střední', planned: true },
    { id: 'plan-w12-po-bicep-curl', date: '2026-11-16', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T12 · 3 × 10–12 · střední', planned: true },
  ],
  'bicep-curl-2': [
    { id: 'plan-w1-ct-bicep-curl-2', date: '2026-09-03', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T1 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w2-ct-bicep-curl-2', date: '2026-09-10', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T2 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w3-ct-bicep-curl-2', date: '2026-09-17', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T3 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w5-ct-bicep-curl-2', date: '2026-10-01', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T5 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w6-ct-bicep-curl-2', date: '2026-10-08', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T6 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w7-ct-bicep-curl-2', date: '2026-10-15', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T7 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w9-ct-bicep-curl-2', date: '2026-10-29', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T9 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w10-ct-bicep-curl-2', date: '2026-11-05', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T10 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w11-ct-bicep-curl-2', date: '2026-11-12', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T11 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w12-ct-bicep-curl-2', date: '2026-11-19', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T12 · 3 × 8–10 · střední', planned: true },
  ],
  'bulgarian': [
    { id: 'plan-w1-ne-bulgarian', date: '2026-09-06', sets: '3', weight: '0', reps: '8–10/nohu', note: 'PLÁN · T1 · 3 × 8–10/nohu · 2× činka střední', planned: true },
    { id: 'plan-w2-ne-bulgarian', date: '2026-09-13', sets: '3', weight: '0', reps: '8–10/nohu', note: 'PLÁN · T2 · 3 × 8–10/nohu · 2× činka střední', planned: true },
    { id: 'plan-w3-ne-bulgarian', date: '2026-09-20', sets: '3', weight: '0', reps: '6/nohu', note: 'PLÁN · T3 · 3 × 6/nohu · 2× činka střední', planned: true },
  ],
  'chest-supported-row': [
    { id: 'plan-w5-ct-chest-supported-row', date: '2026-10-01', sets: '4', weight: '0', reps: '5', note: 'PLÁN · T5 · 4 × 5 · stroj těžká', planned: true },
    { id: 'plan-w6-ct-chest-supported-row', date: '2026-10-08', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T6 · 3 × 8–10 · stroj střední', planned: true },
    { id: 'plan-w7-ct-chest-supported-row', date: '2026-10-15', sets: '4', weight: '0', reps: '5', note: 'PLÁN · T7 · 4 × 5 · stroj těžká', planned: true },
    { id: 'plan-w8-ct-chest-supported-row', date: '2026-10-22', sets: '2', weight: '0', reps: '8', note: 'PLÁN · T8 · 2 × 8 · stroj lehká', planned: true },
  ],
  'deadlift': [
    { id: 'plan-w1-ct-deadlift-0', date: '2026-09-03', sets: '1', weight: '180', reps: '8', note: 'PLÁN · T1 · Objemová · RPE 7-8', planned: true },
    { id: 'plan-w1-ct-deadlift-1', date: '2026-09-03', sets: '1', weight: '202.5', reps: '3', note: 'PLÁN · T1 · OVERLOAD · RPE 8', planned: true },
    { id: 'plan-w1-ct-deadlift-2', date: '2026-09-03', sets: '1', weight: '190', reps: '6', note: 'PLÁN · T1 · Back-off · RPE 7-8', planned: true },
    { id: 'plan-w2-ct-deadlift-0', date: '2026-09-10', sets: '1', weight: '185', reps: '8', note: 'PLÁN · T2 · Objemová · RPE 8', planned: true },
    { id: 'plan-w2-ct-deadlift-1', date: '2026-09-10', sets: '1', weight: '207.5', reps: '2', note: 'PLÁN · T2 · OVERLOAD · RPE 8', planned: true },
    { id: 'plan-w2-ct-deadlift-2', date: '2026-09-10', sets: '1', weight: '195', reps: '6', note: 'PLÁN · T2 · Back-off · RPE 8', planned: true },
    { id: 'plan-w3-ct-deadlift-0', date: '2026-09-17', sets: '1', weight: '187.5', reps: '6', note: 'PLÁN · T3 · Objemová · RPE 8', planned: true },
    { id: 'plan-w3-ct-deadlift-1', date: '2026-09-17', sets: '1', weight: '212.5', reps: '2', note: 'PLÁN · T3 · OVERLOAD · RPE 8-9', planned: true },
    { id: 'plan-w3-ct-deadlift-2', date: '2026-09-17', sets: '1', weight: '197.5', reps: '6', note: 'PLÁN · T3 · Back-off · RPE 8', planned: true },
    { id: 'plan-w4-ct-deadlift-0', date: '2026-09-24', sets: '1', weight: '160', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6', planned: true },
    { id: 'plan-w4-ct-deadlift-1', date: '2026-09-24', sets: '1', weight: '160', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6', planned: true },
    { id: 'plan-w4-ct-deadlift-2', date: '2026-09-24', sets: '1', weight: '165', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w5-ct-deadlift-0', date: '2026-10-01', sets: '1', weight: '195', reps: '5', note: 'PLÁN · T5 · TOP · RPE 8', planned: true },
    { id: 'plan-w5-ct-deadlift-1', date: '2026-10-01', sets: '1', weight: '205', reps: '3', note: 'PLÁN · T5 · OVERLOAD · RPE 8-9', planned: true },
    { id: 'plan-w5-ct-deadlift-2', date: '2026-10-01', sets: '1', weight: '187.5', reps: '5', note: 'PLÁN · T5 · Back-off · RPE 8', planned: true },
    { id: 'plan-w6-ct-deadlift-0', date: '2026-10-08', sets: '1', weight: '200', reps: '4', note: 'PLÁN · T6 · TOP · RPE 8', planned: true },
    { id: 'plan-w6-ct-deadlift-1', date: '2026-10-08', sets: '1', weight: '210', reps: '2', note: 'PLÁN · T6 · OVERLOAD · RPE 9', planned: true },
    { id: 'plan-w6-ct-deadlift-2', date: '2026-10-08', sets: '1', weight: '192.5', reps: '5', note: 'PLÁN · T6 · Back-off · RPE 8', planned: true },
    { id: 'plan-w7-ct-deadlift-0', date: '2026-10-15', sets: '1', weight: '207.5', reps: '3', note: 'PLÁN · T7 · TOP · RPE 8-9', planned: true },
    { id: 'plan-w7-ct-deadlift-1', date: '2026-10-15', sets: '1', weight: '215', reps: '2', note: 'PLÁN · T7 · OVERLOAD · RPE 9', planned: true },
    { id: 'plan-w7-ct-deadlift-2', date: '2026-10-15', sets: '1', weight: '195', reps: '4', note: 'PLÁN · T7 · Back-off · RPE 8', planned: true },
    { id: 'plan-w8-ct-deadlift-0', date: '2026-10-22', sets: '1', weight: '172.5', reps: '3', note: 'PLÁN · T8 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w8-ct-deadlift-1', date: '2026-10-22', sets: '1', weight: '172.5', reps: '3', note: 'PLÁN · T8 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w8-ct-deadlift-2', date: '2026-10-22', sets: '1', weight: '177.5', reps: '3', note: 'PLÁN · T8 · Deload · RPE 7', planned: true },
    { id: 'plan-w9-ct-deadlift-0', date: '2026-10-29', sets: '1', weight: '202.5', reps: '3', note: 'PLÁN · T9 · Nájezd · RPE 8', planned: true },
    { id: 'plan-w9-ct-deadlift-1', date: '2026-10-29', sets: '1', weight: '215', reps: '2', note: 'PLÁN · T9 · TOP · RPE 9', planned: true },
    { id: 'plan-w9-ct-deadlift-2', date: '2026-10-29', sets: '1', weight: '195', reps: '5', note: 'PLÁN · T9 · Back-off · RPE 8', planned: true },
    { id: 'plan-w10-ct-deadlift-0', date: '2026-11-05', sets: '1', weight: '207.5', reps: '2', note: 'PLÁN · T10 · Nájezd · RPE 8', planned: true },
    { id: 'plan-w10-ct-deadlift-1', date: '2026-11-05', sets: '1', weight: '217.5', reps: '1', note: 'PLÁN · T10 · TOP single · RPE 9', planned: true },
    { id: 'plan-w10-ct-deadlift-2', date: '2026-11-05', sets: '1', weight: '200', reps: '4', note: 'PLÁN · T10 · Back-off · RPE 8', planned: true },
    { id: 'plan-w11-ct-deadlift-0', date: '2026-11-12', sets: '1', weight: '212.5', reps: '2', note: 'PLÁN · T11 · Nájezd · RPE 8-9', planned: true },
    { id: 'plan-w11-ct-deadlift-1', date: '2026-11-12', sets: '1', weight: '222.5', reps: '1', note: 'PLÁN · T11 · TOP single · RPE 9', planned: true },
    { id: 'plan-w11-ct-deadlift-2', date: '2026-11-12', sets: '1', weight: '202.5', reps: '3', note: 'PLÁN · T11 · Back-off · RPE 8', planned: true },
    { id: 'plan-w12-ct-deadlift-0', date: '2026-11-19', sets: '1', weight: '207.5', reps: '1', note: 'PLÁN · T12 · Opener · RPE 7', planned: true },
    { id: 'plan-w12-ct-deadlift-1', date: '2026-11-19', sets: '1', weight: '195', reps: '2', note: 'PLÁN · T12 · Druhá · RPE 7', planned: true },
    { id: 'plan-w12-ct-deadlift-2', date: '2026-11-19', sets: '1', weight: '185', reps: '3', note: 'PLÁN · T12 · Objem · RPE 7', planned: true },
    { id: 'plan-w13-ct-deadlift-0', date: '2026-11-26', sets: '1', weight: '180', reps: '1', note: 'PLÁN · T13 · Rozjezd', planned: true },
    { id: 'plan-w13-ct-deadlift-1', date: '2026-11-26', sets: '1', weight: '207.5', reps: '1', note: 'PLÁN · T13 · Rozjezd', planned: true },
    { id: 'plan-w13-ct-deadlift-2', date: '2026-11-26', sets: '1', weight: '230', reps: '1', note: 'PLÁN · T13 · CÍL', planned: true },
    { id: 'plan-w13-ct-deadlift-3', date: '2026-11-26', sets: '1', weight: '235', reps: '1', note: 'PLÁN · T13 · PR pokus', planned: true },
  ],
  'face-pulls': [
    { id: 'plan-w1-po-face-pulls', date: '2026-08-31', sets: '3', weight: '0', reps: '15–20', note: 'PLÁN · T1 · 3 × 15–20 · lehká', planned: true },
    { id: 'plan-w2-po-face-pulls', date: '2026-09-07', sets: '3', weight: '0', reps: '15–20', note: 'PLÁN · T2 · 3 × 15–20 · lehká', planned: true },
    { id: 'plan-w4-po-face-pulls', date: '2026-09-21', sets: '3', weight: '0', reps: '15', note: 'PLÁN · T4 · 3 × 15 · lehká', planned: true },
    { id: 'plan-w6-po-face-pulls', date: '2026-10-05', sets: '3', weight: '0', reps: '15–20', note: 'PLÁN · T6 · 3 × 15–20 · lehká', planned: true },
    { id: 'plan-w8-po-face-pulls', date: '2026-10-19', sets: '3', weight: '0', reps: '15', note: 'PLÁN · T8 · 3 × 15 · lehká', planned: true },
    { id: 'plan-w10-po-face-pulls', date: '2026-11-02', sets: '3', weight: '0', reps: '15–20', note: 'PLÁN · T10 · 3 × 15–20 · lehká', planned: true },
    { id: 'plan-w12-po-face-pulls', date: '2026-11-16', sets: '3', weight: '0', reps: '15–20', note: 'PLÁN · T12 · 3 × 15–20 · lehká', planned: true },
  ],
  'ghd': [
    { id: 'plan-w5-ct-ghd', date: '2026-10-01', sets: '3', weight: '0', reps: '4–6', note: 'PLÁN · T5 · 3 × 4–6 · vlastní', planned: true },
    { id: 'plan-w7-ct-ghd', date: '2026-10-15', sets: '3', weight: '0', reps: '4–6', note: 'PLÁN · T7 · 3 × 4–6 · vlastní', planned: true },
  ],
  'leg-press': [
    { id: 'plan-w9-ne-leg-press', date: '2026-11-01', sets: '4', weight: '0', reps: '6–8', note: 'PLÁN · T9 · 4 × 6–8 · stroj střední–těžká, RPE 8', planned: true },
    { id: 'plan-w10-ne-leg-press', date: '2026-11-08', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T10 · 3 × 10–12 · stroj střední–těžká, RPE 8', planned: true },
    { id: 'plan-w11-ne-leg-press', date: '2026-11-15', sets: '4', weight: '0', reps: '6–8', note: 'PLÁN · T11 · 4 × 6–8 · stroj střední–těžká, RPE 8', planned: true },
    { id: 'plan-w12-ne-leg-press', date: '2026-11-22', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T12 · 3 × 10–12 · stroj střední–těžká, RPE 8', planned: true },
  ],
  'long-pause-bench': [
    { id: 'plan-w5-po-long-pause-bench', date: '2026-09-28', sets: '3', weight: '102.5', reps: '4', note: 'PLÁN · T5 · 3 × 4', planned: true },
    { id: 'plan-w7-po-long-pause-bench', date: '2026-10-12', sets: '3', weight: '102.5', reps: '4', note: 'PLÁN · T7 · 3 × 4', planned: true },
  ],
  'nordic-curls': [
    { id: 'plan-w3-ct-nordic-curls', date: '2026-09-17', sets: '3', weight: '0', reps: '4–6', note: 'PLÁN · T3 · 3 × 4–6 · vlastní', planned: true },
    { id: 'plan-w9-ct-nordic-curls', date: '2026-10-29', sets: '3', weight: '0', reps: '4–6', note: 'PLÁN · T9 · 3 × 4–6 · vlastní', planned: true },
    { id: 'plan-w11-ct-nordic-curls', date: '2026-11-12', sets: '3', weight: '0', reps: '4–6', note: 'PLÁN · T11 · 3 × 4–6 · vlastní', planned: true },
  ],
  'pallof': [
    { id: 'plan-w1-ne-pallof', date: '2026-09-06', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T1 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w2-ne-pallof', date: '2026-09-13', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T2 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w3-ne-pallof', date: '2026-09-20', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T3 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w5-ne-pallof', date: '2026-10-04', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T5 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w6-ne-pallof', date: '2026-10-11', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T6 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w7-ne-pallof', date: '2026-10-18', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T7 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w9-ne-pallof', date: '2026-11-01', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T9 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w10-ne-pallof', date: '2026-11-08', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T10 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w11-ne-pallof', date: '2026-11-15', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T11 · 2 × 10/str. · lehká', planned: true },
    { id: 'plan-w12-ne-pallof', date: '2026-11-22', sets: '2', weight: '0', reps: '10/str.', note: 'PLÁN · T12 · 2 × 10/str. · lehká', planned: true },
  ],
  'pause-squat': [
    { id: 'plan-w1-ne-pause-squat', date: '2026-09-06', sets: '3', weight: '132.5', reps: '5', note: 'PLÁN · T1 · 3 × 5', planned: true },
    { id: 'plan-w2-ne-pause-squat', date: '2026-09-13', sets: '3', weight: '132.5', reps: '5', note: 'PLÁN · T2 · 3 × 5', planned: true },
    { id: 'plan-w3-ne-pause-squat', date: '2026-09-20', sets: '3', weight: '145', reps: '3', note: 'PLÁN · T3 · 3 × 3', planned: true },
    { id: 'plan-w4-ne-pause-squat', date: '2026-09-27', sets: '2', weight: '115', reps: '5', note: 'PLÁN · T4 · 2 × 5', planned: true },
    { id: 'plan-w8-ne-pause-squat', date: '2026-10-25', sets: '2', weight: '125', reps: '3', note: 'PLÁN · T8 · 2 × 3', planned: true },
    { id: 'plan-w9-ne-pause-squat', date: '2026-11-01', sets: '3', weight: '147.5', reps: '3', note: 'PLÁN · T9 · 3 × 3', planned: true },
    { id: 'plan-w10-ne-pause-squat', date: '2026-11-08', sets: '3', weight: '137.5', reps: '5', note: 'PLÁN · T10 · 3 × 5', planned: true },
    { id: 'plan-w11-ne-pause-squat', date: '2026-11-15', sets: '3', weight: '147.5', reps: '3', note: 'PLÁN · T11 · 3 × 3', planned: true },
    { id: 'plan-w12-ne-pause-squat', date: '2026-11-22', sets: '3', weight: '147.5', reps: '3', note: 'PLÁN · T12 · 3 × 3', planned: true },
  ],
  'paused-bench': [
    { id: 'plan-w3-po-paused-bench', date: '2026-09-14', sets: '3', weight: '105', reps: '4', note: 'PLÁN · T3 · 3 × 4', planned: true },
  ],
  'pendlay-row': [
    { id: 'plan-w9-ct-pendlay-row', date: '2026-10-29', sets: '4', weight: '97.5', reps: '5', note: 'PLÁN · T9 · 4 × 5', planned: true },
    { id: 'plan-w10-ct-pendlay-row', date: '2026-11-05', sets: '3', weight: '82.5', reps: '8–10', note: 'PLÁN · T10 · 3 × 8–10', planned: true },
    { id: 'plan-w11-ct-pendlay-row', date: '2026-11-12', sets: '4', weight: '97.5', reps: '5', note: 'PLÁN · T11 · 4 × 5', planned: true },
    { id: 'plan-w12-ct-pendlay-row', date: '2026-11-19', sets: '3', weight: '82.5', reps: '8–10', note: 'PLÁN · T12 · 3 × 8–10', planned: true },
  ],
  'pin-press': [
    { id: 'plan-w9-po-pin-press', date: '2026-10-26', sets: '3', weight: '107.5', reps: '4', note: 'PLÁN · T9 · 3 × 4', planned: true },
    { id: 'plan-w11-po-pin-press', date: '2026-11-09', sets: '3', weight: '107.5', reps: '4', note: 'PLÁN · T11 · 3 × 4', planned: true },
  ],
  'pin-squat': [
    { id: 'plan-w5-ne-pin-squat', date: '2026-10-04', sets: '3', weight: '145', reps: '3', note: 'PLÁN · T5 · 3 × 3', planned: true },
    { id: 'plan-w6-ne-pin-squat', date: '2026-10-11', sets: '3', weight: '132.5', reps: '5', note: 'PLÁN · T6 · 3 × 5', planned: true },
    { id: 'plan-w7-ne-pin-squat', date: '2026-10-18', sets: '3', weight: '145', reps: '3', note: 'PLÁN · T7 · 3 × 3', planned: true },
  ],
  'pullup': [
    { id: 'plan-w1-po-pullup', date: '2026-08-31', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T1 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w2-po-pullup', date: '2026-09-07', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T2 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w3-po-pullup', date: '2026-09-14', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T3 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w4-po-pullup', date: '2026-09-21', sets: '2', weight: '0', reps: '6', note: 'PLÁN · T4 · 2 × 6 · vlastní', planned: true },
    { id: 'plan-w5-po-pullup', date: '2026-09-28', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T5 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w6-po-pullup', date: '2026-10-05', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T6 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w7-po-pullup', date: '2026-10-12', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T7 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w8-po-pullup', date: '2026-10-19', sets: '2', weight: '0', reps: '6', note: 'PLÁN · T8 · 2 × 6 · vlastní', planned: true },
    { id: 'plan-w9-po-pullup', date: '2026-10-26', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T9 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w10-po-pullup', date: '2026-11-02', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T10 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w11-po-pullup', date: '2026-11-09', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T11 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w12-po-pullup', date: '2026-11-16', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T12 · 3 × 8 · vlastní', planned: true },
  ],
  'pullup-back': [
    { id: 'plan-w1-ct-pullup-back', date: '2026-09-03', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T1 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w2-ct-pullup-back', date: '2026-09-10', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T2 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w3-ct-pullup-back', date: '2026-09-17', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T3 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w4-ct-pullup-back', date: '2026-09-24', sets: '2', weight: '0', reps: '6', note: 'PLÁN · T4 · 2 × 6 · vlastní', planned: true },
    { id: 'plan-w5-ct-pullup-back', date: '2026-10-01', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T5 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w6-ct-pullup-back', date: '2026-10-08', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T6 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w7-ct-pullup-back', date: '2026-10-15', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T7 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w8-ct-pullup-back', date: '2026-10-22', sets: '2', weight: '0', reps: '6', note: 'PLÁN · T8 · 2 × 6 · vlastní', planned: true },
    { id: 'plan-w9-ct-pullup-back', date: '2026-10-29', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T9 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w10-ct-pullup-back', date: '2026-11-05', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T10 · 3 × 8 · vlastní', planned: true },
    { id: 'plan-w11-ct-pullup-back', date: '2026-11-12', sets: '3', weight: '0', reps: '5', note: 'PLÁN · T11 · 3 × 5 · +5–10 kg', planned: true },
    { id: 'plan-w12-ct-pullup-back', date: '2026-11-19', sets: '3', weight: '0', reps: '8', note: 'PLÁN · T12 · 3 × 8 · vlastní', planned: true },
  ],
  'spoto': [
    { id: 'plan-w1-po-spoto', date: '2026-08-31', sets: '3', weight: '100', reps: '6', note: 'PLÁN · T1 · 3 × 6', planned: true },
    { id: 'plan-w2-po-spoto', date: '2026-09-07', sets: '3', weight: '100', reps: '6', note: 'PLÁN · T2 · 3 × 6', planned: true },
    { id: 'plan-w6-po-spoto', date: '2026-10-05', sets: '3', weight: '100', reps: '6', note: 'PLÁN · T6 · 3 × 6', planned: true },
    { id: 'plan-w10-po-spoto', date: '2026-11-02', sets: '3', weight: '102.5', reps: '6', note: 'PLÁN · T10 · 3 × 6', planned: true },
    { id: 'plan-w12-po-spoto', date: '2026-11-16', sets: '3', weight: '102.5', reps: '6', note: 'PLÁN · T12 · 3 × 6', planned: true },
  ],
  'squat': [
    { id: 'plan-w1-ne-squat-0', date: '2026-09-06', sets: '1', weight: '145', reps: '8', note: 'PLÁN · T1 · Objemová · RPE 7-8', planned: true },
    { id: 'plan-w1-ne-squat-1', date: '2026-09-06', sets: '1', weight: '162.5', reps: '3', note: 'PLÁN · T1 · OVERLOAD · RPE 8', planned: true },
    { id: 'plan-w1-ne-squat-2', date: '2026-09-06', sets: '1', weight: '152.5', reps: '6', note: 'PLÁN · T1 · Back-off · RPE 7-8', planned: true },
    { id: 'plan-w1-ne-squat-3', date: '2026-09-06', sets: '1', weight: '152.5', reps: '6', note: 'PLÁN · T1 · Back-off · RPE 7-8', planned: true },
    { id: 'plan-w2-ne-squat-0', date: '2026-09-13', sets: '1', weight: '147.5', reps: '8', note: 'PLÁN · T2 · Objemová · RPE 8', planned: true },
    { id: 'plan-w2-ne-squat-1', date: '2026-09-13', sets: '1', weight: '167.5', reps: '2', note: 'PLÁN · T2 · OVERLOAD · RPE 8', planned: true },
    { id: 'plan-w2-ne-squat-2', date: '2026-09-13', sets: '1', weight: '152.5', reps: '6', note: 'PLÁN · T2 · Back-off · RPE 8', planned: true },
    { id: 'plan-w2-ne-squat-3', date: '2026-09-13', sets: '1', weight: '152.5', reps: '5', note: 'PLÁN · T2 · Back-off · RPE 8', planned: true },
    { id: 'plan-w3-ne-squat-0', date: '2026-09-20', sets: '1', weight: '152.5', reps: '6', note: 'PLÁN · T3 · Objemová · RPE 8', planned: true },
    { id: 'plan-w3-ne-squat-1', date: '2026-09-20', sets: '1', weight: '170', reps: '2', note: 'PLÁN · T3 · OVERLOAD · RPE 8-9', planned: true },
    { id: 'plan-w3-ne-squat-2', date: '2026-09-20', sets: '1', weight: '155', reps: '6', note: 'PLÁN · T3 · Back-off · RPE 8', planned: true },
    { id: 'plan-w3-ne-squat-3', date: '2026-09-20', sets: '1', weight: '155', reps: '5', note: 'PLÁN · T3 · Back-off · RPE 8', planned: true },
    { id: 'plan-w4-ne-squat-0', date: '2026-09-27', sets: '1', weight: '130', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6', planned: true },
    { id: 'plan-w4-ne-squat-1', date: '2026-09-27', sets: '1', weight: '130', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6', planned: true },
    { id: 'plan-w4-ne-squat-2', date: '2026-09-27', sets: '1', weight: '132.5', reps: '5', note: 'PLÁN · T4 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w5-ne-squat-0', date: '2026-10-04', sets: '1', weight: '157.5', reps: '5', note: 'PLÁN · T5 · TOP · RPE 8', planned: true },
    { id: 'plan-w5-ne-squat-1', date: '2026-10-04', sets: '1', weight: '165', reps: '3', note: 'PLÁN · T5 · OVERLOAD · RPE 8-9', planned: true },
    { id: 'plan-w5-ne-squat-2', date: '2026-10-04', sets: '1', weight: '152.5', reps: '5', note: 'PLÁN · T5 · Back-off · RPE 8', planned: true },
    { id: 'plan-w5-ne-squat-3', date: '2026-10-04', sets: '1', weight: '152.5', reps: '5', note: 'PLÁN · T5 · Back-off · RPE 8', planned: true },
    { id: 'plan-w6-ne-squat-0', date: '2026-10-11', sets: '1', weight: '160', reps: '4', note: 'PLÁN · T6 · TOP · RPE 8', planned: true },
    { id: 'plan-w6-ne-squat-1', date: '2026-10-11', sets: '1', weight: '167.5', reps: '2', note: 'PLÁN · T6 · OVERLOAD · RPE 9', planned: true },
    { id: 'plan-w6-ne-squat-2', date: '2026-10-11', sets: '1', weight: '155', reps: '5', note: 'PLÁN · T6 · Back-off · RPE 8', planned: true },
    { id: 'plan-w6-ne-squat-3', date: '2026-10-11', sets: '1', weight: '155', reps: '4', note: 'PLÁN · T6 · Back-off · RPE 8', planned: true },
    { id: 'plan-w7-ne-squat-0', date: '2026-10-18', sets: '1', weight: '167.5', reps: '3', note: 'PLÁN · T7 · TOP · RPE 8-9', planned: true },
    { id: 'plan-w7-ne-squat-1', date: '2026-10-18', sets: '1', weight: '172.5', reps: '2', note: 'PLÁN · T7 · OVERLOAD · RPE 9', planned: true },
    { id: 'plan-w7-ne-squat-2', date: '2026-10-18', sets: '1', weight: '157.5', reps: '4', note: 'PLÁN · T7 · Back-off · RPE 8', planned: true },
    { id: 'plan-w7-ne-squat-3', date: '2026-10-18', sets: '1', weight: '157.5', reps: '4', note: 'PLÁN · T7 · Back-off · RPE 8', planned: true },
    { id: 'plan-w8-ne-squat-0', date: '2026-10-25', sets: '1', weight: '140', reps: '3', note: 'PLÁN · T8 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w8-ne-squat-1', date: '2026-10-25', sets: '1', weight: '140', reps: '3', note: 'PLÁN · T8 · Deload · RPE 6-7', planned: true },
    { id: 'plan-w8-ne-squat-2', date: '2026-10-25', sets: '1', weight: '142.5', reps: '3', note: 'PLÁN · T8 · Deload · RPE 7', planned: true },
    { id: 'plan-w9-ne-squat-0', date: '2026-11-01', sets: '1', weight: '162.5', reps: '3', note: 'PLÁN · T9 · Nájezd · RPE 8', planned: true },
    { id: 'plan-w9-ne-squat-1', date: '2026-11-01', sets: '1', weight: '172.5', reps: '2', note: 'PLÁN · T9 · TOP · RPE 9', planned: true },
    { id: 'plan-w9-ne-squat-2', date: '2026-11-01', sets: '1', weight: '157.5', reps: '5', note: 'PLÁN · T9 · Back-off · RPE 8', planned: true },
    { id: 'plan-w9-ne-squat-3', date: '2026-11-01', sets: '1', weight: '157.5', reps: '5', note: 'PLÁN · T9 · Back-off · RPE 8', planned: true },
    { id: 'plan-w10-ne-squat-0', date: '2026-11-08', sets: '1', weight: '167.5', reps: '2', note: 'PLÁN · T10 · Nájezd · RPE 8', planned: true },
    { id: 'plan-w10-ne-squat-1', date: '2026-11-08', sets: '1', weight: '175', reps: '1', note: 'PLÁN · T10 · TOP single · RPE 9', planned: true },
    { id: 'plan-w10-ne-squat-2', date: '2026-11-08', sets: '1', weight: '160', reps: '4', note: 'PLÁN · T10 · Back-off · RPE 8', planned: true },
    { id: 'plan-w10-ne-squat-3', date: '2026-11-08', sets: '1', weight: '160', reps: '3', note: 'PLÁN · T10 · Back-off · RPE 8', planned: true },
    { id: 'plan-w11-ne-squat-0', date: '2026-11-15', sets: '1', weight: '170', reps: '2', note: 'PLÁN · T11 · Nájezd · RPE 8-9', planned: true },
    { id: 'plan-w11-ne-squat-1', date: '2026-11-15', sets: '1', weight: '180', reps: '1', note: 'PLÁN · T11 · TOP single · RPE 9', planned: true },
    { id: 'plan-w11-ne-squat-2', date: '2026-11-15', sets: '1', weight: '162.5', reps: '3', note: 'PLÁN · T11 · Back-off · RPE 8', planned: true },
    { id: 'plan-w11-ne-squat-3', date: '2026-11-15', sets: '1', weight: '162.5', reps: '3', note: 'PLÁN · T11 · Back-off · RPE 8', planned: true },
    { id: 'plan-w12-ne-squat-0', date: '2026-11-22', sets: '1', weight: '167.5', reps: '1', note: 'PLÁN · T12 · Opener · RPE 7', planned: true },
    { id: 'plan-w12-ne-squat-1', date: '2026-11-22', sets: '1', weight: '157.5', reps: '2', note: 'PLÁN · T12 · Druhá · RPE 7', planned: true },
    { id: 'plan-w12-ne-squat-2', date: '2026-11-22', sets: '1', weight: '147.5', reps: '3', note: 'PLÁN · T12 · Objem · RPE 7', planned: true },
    { id: 'plan-w13-ne-squat-0', date: '2026-11-29', sets: '1', weight: '150', reps: '1', note: 'PLÁN · T13 · Rozjezd', planned: true },
    { id: 'plan-w13-ne-squat-1', date: '2026-11-29', sets: '1', weight: '170', reps: '1', note: 'PLÁN · T13 · Rozjezd', planned: true },
    { id: 'plan-w13-ne-squat-2', date: '2026-11-29', sets: '1', weight: '190', reps: '1', note: 'PLÁN · T13 · CÍL', planned: true },
    { id: 'plan-w13-ne-squat-3', date: '2026-11-29', sets: '1', weight: '195', reps: '1', note: 'PLÁN · T13 · PR (volitelně)', planned: true },
  ],
  'triceps-overhead': [
    { id: 'plan-w5-po-triceps-overhead', date: '2026-09-28', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T5 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w6-po-triceps-overhead', date: '2026-10-05', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T6 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w7-po-triceps-overhead', date: '2026-10-12', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T7 · 3 × 8–10 · střední', planned: true },
  ],
  'triceps-pushdown': [
    { id: 'plan-w1-po-triceps-pushdown', date: '2026-08-31', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T1 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w2-po-triceps-pushdown', date: '2026-09-07', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T2 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w3-po-triceps-pushdown', date: '2026-09-14', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T3 · 3 × 8–10 · střední', planned: true },
  ],
  'triceps-skull': [
    { id: 'plan-w9-po-triceps-skull', date: '2026-10-26', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T9 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w10-po-triceps-skull', date: '2026-11-02', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T10 · 3 × 10–12 · střední', planned: true },
    { id: 'plan-w11-po-triceps-skull', date: '2026-11-09', sets: '3', weight: '0', reps: '8–10', note: 'PLÁN · T11 · 3 × 8–10 · střední', planned: true },
    { id: 'plan-w12-po-triceps-skull', date: '2026-11-16', sets: '3', weight: '0', reps: '10–12', note: 'PLÁN · T12 · 3 × 10–12 · střední', planned: true },
  ],
  'walking-lunges': [
    { id: 'plan-w5-ne-walking-lunges', date: '2026-10-04', sets: '3', weight: '0', reps: '8/nohu', note: 'PLÁN · T5 · 3 × 8/nohu · 2× činka lehká–stř.', planned: true },
    { id: 'plan-w6-ne-walking-lunges', date: '2026-10-11', sets: '3', weight: '0', reps: '10/nohu', note: 'PLÁN · T6 · 3 × 10/nohu · 2× činka lehká–stř.', planned: true },
    { id: 'plan-w7-ne-walking-lunges', date: '2026-10-18', sets: '3', weight: '0', reps: '8/nohu', note: 'PLÁN · T7 · 3 × 8/nohu · 2× činka lehká–stř.', planned: true },
  ],
};
